            ...
            <div class="navbar-brand">
                <a href="{{ url('/dashboard') }}">
                    <b class="logo-icon">
                        ...
                        <img src="{{ asset('assets/img/user.png') }}" alt="homepage" class="light-logo" />
                    </b>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <img src="{{ asset('assets/img/user.png') }}" alt="user" class="rounded-circle"
                            width="40">
                        <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark">{{ Auth::user()->name_surname }}</span>
