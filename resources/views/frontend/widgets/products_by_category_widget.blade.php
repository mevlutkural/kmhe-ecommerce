                    ...
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <h6 class="text-muted ml-2">
                                    <del>{{ $product->product_price = $product->product_price * 1.5 }}$</del>
                                </h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="{{ url('/products/' . $product->product_id . '/product-details') }}"
                                ...
                                Detail</a>
                            <button
                                onclick="addToCart({{ $product->product_id }}, {{ $user_id }}, '{{ url('/add-to-cart') }}', '{{ csrf_token() }}')"
                                class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add
                                To Cart</button>
                        </div>
                    </div>
                </div>
